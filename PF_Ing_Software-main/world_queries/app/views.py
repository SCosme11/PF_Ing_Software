...
from .queries import consulta_poblacion_promedio_continente, consulta_ciudades_por_pais, consulta_lenguajes_por_pais, consulta_idiomas_por_pais, consulta_paises_mas_50_millones, consulta_todos_los_paises
...
def register_routes(app):
    ...
    @app.route('/consulta1')
    def consulta_1():
        resultados = consulta_poblacion_promedio_continente()
